...
namespace NFS {
    ...
    class Read3Worker : public Procedure3Worker<READ3args, READ3res> {
    ...
    private:
        ...
        clnt_stat xdrProc(READ3args *a, READ3res *r, CLIENT *c) NFSC_OVERRIDE {
            return nfsproc3_read_3(a, r, c);
        }
