...
namespace NFS {
    ...
    class Access3Worker : public Procedure3Worker<ACCESS3args, ACCESS3res> {
    ...
    private:
        clnt_stat xdrProc(ACCESS3args *a, ACCESS3res *r, CLIENT *c) NFSC_OVERRIDE {
            return nfsproc3_access_3(a, r, c);
        }
